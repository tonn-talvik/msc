...
Mitte-determistliku keele arvutused võivad omada tervet hulka erinevaid väärtuseid.
...
Väärtustermid on mõlemal keelel ühised.
...
Eeljärjestatud monoid {\tt ℕ*} ja parametriseeritud tüübikonstruktor {\tt TBV}, mis annab vastava ülalt tõkestatud vektori tüübi, rahuldavad gradeeritud monaadi omadusi (alaptk \ref{sssec:graded-monad}). Tagastamine {\tt ηBV} koostab üheelemendilise ülalt tõkestatud, kuid ilma lõtkuta, vektori. Sidumine {\tt bindBV}...
Vastav instants {\tt NDBV} on toodud joonisel \ref{fig:nd.graded-monad}.
...
\begin{itemize}
\item {\tt VAL x} korral tagastab {\tt η} väärtustermi {\tt x} interpretatsiooni.
