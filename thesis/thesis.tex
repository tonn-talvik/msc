...
\begin{itemize}
  ...
  \item {\tt TRY_WITH_} on arvutuse erandikäsitleja: kogu arvutuse tulemuseks on esimese argumendiga antud termi arvutus, kui see õnnestub, vastasel korral aga teise argumendiga antud termi arvutus.
...
\begin{center}
  ...
  \end{tikzpicture}
\end{center}
Hinnangute järjestusseos {\tt _⊑_} on toodud joonisel \ref{fig:exc.exc}.
