...
\subsection{Tüübituletus ja efektianalüüs} \label{ssec:exc.inference}
...
Rafineeritud arvutusliikmed (jn \ref{fig:exc.refined}) määravad täpselt efektide kombineerimise.
\begin{itemize}
